                            ...
                            <tbody>
                                @foreach ($submissions as $submission)
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="{{ url('akademik_kemahasiswaan/persetujuan/aula/detail/' . $submission->id) }}"
                                            ...
                                            @if (!$submission->assign_4 && $submission->assign_2 == 'Disetujui' && $submission->assign_5 == 'Disetujui')
                                                <a href="{{ url('akademik_kemahasiswaan/persetujuan/aula/approve/' . $submission->id) }}"
                                                    class="btn btn-sm btn-success mt-1">Setuju</a>
                                                <a href="{{ url('akademik_kemahasiswaan/persetujuan/aula/reject/' . $submission->id) }}"
