    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="row text-center">
                    <div class="col-4">{!! DNS2D::getBarcodeSVG(asset('signature/' . $detailSubmissions->chairman), 'QRCODE') !!}</div>
                    <div class="col-4"></div>
                    <div class="col-4">{!! DNS2D::getBarcodeSVG(asset('signature/' . $detailSubmissions->chairman_of_the_commitee), 'QRCODE') !!}</div>
                </div>
                <div class="row text-center">
