                            ...
                            <tbody>
                                @foreach ($submissions as $submission)
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="{{ url('kemahasiswaan/persetujuan/aula/detail/' . $submission->id) }}"
                                                class="btn btn-sm btn-info mt-1"><i class="flaticon-381-list"></i></a>
                                            @if (!$submission->assign_5 && $submission->assign_2 == 'Disetujui')
                                                <a href="{{ url('kemahasiswaan/persetujuan/aula/approve/' . $submission->id) }}"
                                                    class="btn btn-sm btn-success mt-1">Setuju</a>
                                                <a href="{{ url('kemahasiswaan/persetujuan/aula/reject/' . $submission->id) }}"
