        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ url('kemahasiswaan/fasilitas', []) }}" class="btn btn-danger light float-right"
            ...
            <div class="modal fade" id="exampleModalCenter">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('kemahasiswaan/fasilitas/fasilitas-save', []) }}" method="POST"
                                ...
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        {{-- <td class="text-center">
                                            <a href="{{ url('kemahasiswaan/fasilitas/fasilitas-edit/' . $data->id, []) }}"
                                                class="btn btn-sm btn-warning"><i class="flaticon-381-edit-1"></i></a>
                                            <a href="{{ url('kemahasiswaan/alat/softdelete/' . $data->id) }}"
