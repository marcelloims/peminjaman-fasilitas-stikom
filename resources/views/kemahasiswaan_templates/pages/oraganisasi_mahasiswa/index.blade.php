            ...
            <div class="modal fade" id="exampleModalCenter">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('kemahasiswaan/organisasi-mahasiswa/save', []) }}" method="POST"
                            ...
                            <tbody>
                                @foreach ($ukms as $ukm)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('kemahasiswaan/organisasi-mahasiswa/edit/' . $ukm->id, []) }}"
                                                class="btn btn-sm btn-warning"><i class="flaticon-381-edit-1"></i></a>
                                            <a href="{{ url('kemahasiswaan/organisasi-mahasiswa/softdelete/' . $ukm->id) }}"
