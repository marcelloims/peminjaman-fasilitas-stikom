...
class PersetujuanAulaController extends controller
{
    ...
    public function index()
    {
        ...
        $data['submissions']    = $this->persetujuanAulaService->getData($this->table);

        return view('mahasiswa_templates.pages.persetujuan.Aula.index', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('mahasiswa_templates.pages.persetujuan.Aula.detailPersetujuan', $data);
    }
}
