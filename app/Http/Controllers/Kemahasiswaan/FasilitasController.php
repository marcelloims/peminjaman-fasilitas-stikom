...
class FasilitasController extends Controller
{
    ...
    public function index($id = null)
    {
        ...
        return view('kemahasiswaan_templates.pages.fasilitas.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('kemahasiswaan/fasilitas')->with('message', 'Berhasil disimpan');
    }
    ...
    public function store_tool(Request $request)
    {
        ...
        return redirect('kemahasiswaan/fasilitas/detail/' . $request->fasilitas_id)->with('message', 'Berhasil disimpan');
    }
    ...
    public function show($id)
    {
        ...
        return view('kemahasiswaan_templates.pages.fasilitas.detail', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('kemahasiswaan_templates.pages.fasilitas.edit', $data);
    }
    ...
    public function edit_tool($id)
    {
        ...
        return view('kemahasiswaan_templates.pages.fasilitas.edit_alat', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('kemahasiswaan/fasilitas')->with('message', 'Berhasil diperbaharui');
    }
    ...
    public function update_tool(Request $request, $id)
    {
        ...
        return redirect('kemahasiswaan/fasilitas/detail/' . $request->fasilitas_id)->with('message', 'Berhasil diperbaharui');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('kemahasiswaan/organisasi-mahasiswa')->with('message', 'Has been deleted permanent');
    }

    public function softDelete($id)
    {
        $this->fasilitasService->softDelete($this->table, $id);
        return redirect('kemahasiswaan/fasilitas')->with('message', 'Berhasil dihapus');
    }
    ...
    public function trashed($id = null)
    {
        ...
        return view('kemahasiswaan/organisasi-mahasiswa', $data);
    }

    public function restore($id)
    {
        $this->fasilitasService->restore($this->table, $id);
        return redirect('kemahasiswaan/organisasi-mahasiswa/trashed')->with('message', 'Has been deleted');
    }
}
