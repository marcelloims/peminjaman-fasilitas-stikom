...
class PersetujuanAulaController extends controller
{
    ...
    public function index()
    {
        ...
        return view('kemahasiswaan_templates.pages.persetujuan.aula.index', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('kemahasiswaan_templates.pages.persetujuan.aula.detailPersetujuan', $data);
    }
    ...
    public function approve($id)
    {
        ...
        return redirect('kemahasiswaan/persetujuan/aula')->with('message', 'Telah disetujui');
    }
    ...
    public function reject($id)
    {
        ...
        return redirect('kemahasiswaan/persetujuan/aula')->with('message', 'Telah ditolak');
    }
}
