...
class OrganisasiMahasiswaController extends Controller
{
    ...
    public function index($id = null)
    {
        ...
        return view('kemahasiswaan_templates.pages.oraganisasi_mahasiswa.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('kemahasiswaan/organisasi-mahasiswa')->with('message', 'Berhasil disimpan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('kemahasiswaan_templates.pages.oraganisasi_mahasiswa.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('kemahasiswaan/organisasi-mahasiswa')->with('message', 'Berhasil diperbaharui');
    }

    public function softDelete($id)
    {
        $this->organisasiMahasiswaSerivce->softDelete($this->table, $id);
        return redirect('kemahasiswaan/organisasi-mahasiswa')->with('message', 'Berhasil dihapus');
    }
}
