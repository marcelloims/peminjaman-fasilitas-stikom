...
class MahasiswaController extends Controller
{
    ...
    public function index($id = null)
    {
        ...
        return view('kemahasiswaan_templates.pages.mahasiswa.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('kemahasiswaan/mahasiswa')->with('message', 'Berhasil disimpan');
    }
    ...
    public function show($id)
    {
        ...
        return view('kemahasiswaan_templates.pages.mahasiswa.detail', $data);
    }
}
