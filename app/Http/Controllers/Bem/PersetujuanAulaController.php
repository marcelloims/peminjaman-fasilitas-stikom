...
class PersetujuanAulaController extends controller
{
    ...
    public function index()
    {
        ...
        // dd($data);
        return view('bem_templates.pages.persetujuan.aula.index', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('bem_templates.pages.persetujuan.aula.detailPersetujuan', $data);
    }
    ...
    public function approve($id)
    {
        ...
        return redirect('bem/persetujuan/aula')->with('message', 'Telah disetujui');
    }

    public function reject($id)
    {
        Submission::where('id', $id)->update(['assign_2' => 'Ditolak', 'status' => 'Ditolak']);

        return redirect('bem/persetujuan/aula')->with('message', 'Telah ditolak');
    }
}
