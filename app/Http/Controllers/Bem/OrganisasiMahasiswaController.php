...
class OrganisasiMahasiswaController extends Controller
{
    ...
    public function index($id = null)
    {
        ...
        return view('bem_templates.pages.oraganisasi_mahasiswa.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('bem/organisasi-mahasiswa')->with('message', 'Berhasil disimpan');
    }
    ...
    public function show($id)
    {
        ...
        return view('bem_templates.pages.detail', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('bem_templates.pages.oraganisasi_mahasiswa.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('bem/organisasi-mahasiswa')->with('message', 'Berhasil diperbaharui');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('bem/organisasi-mahasiswa')->with('message', 'Has been deleted permanent');
    }

    public function softDelete($id)
    {
        $this->organisasiMahasiswaSerivce->softDelete($this->table, $id);
        return redirect('bem/organisasi-mahasiswa')->with('message', 'Berhasil dihapus');
    }
    ...
    public function trashed($id = null)
    {
        ...
        return view('bem/organisasi-mahasiswa', $data);
    }

    public function restore($id)
    {
        $this->organisasiMahasiswaSerivce->restore($this->table, $id);
        return redirect('bem/organisasi-mahasiswa/trashed')->with('message', 'Has been deleted');
    }
}
